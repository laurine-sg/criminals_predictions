...
Is there a relationship between the number of criminals of England’s counties and popular instruction, attendance on religious worship, and number of beer-house? To what extent do these features predict the number of criminals in counties?
...
par(cex.lab = 1.5,        # Axis labels (x and y)
